-- Drop the existing restrictive policy and create a secure payment access system
...
-- Create new policy for suppliers that allows viewing but restricts sensitive payment data at application level
