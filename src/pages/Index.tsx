...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-red-900 to-green-900">
      <Navigation />
      ...
      <section className="py-16 bg-gradient-to-r from-green-900 to-black">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
      ...
      {/* Testimonials */}
      <section className="py-16 bg-gradient-to-r from-black to-red-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
